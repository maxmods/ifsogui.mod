...
'Control Window 1
window = ifsoGUI_Window.Create(10, 10, 580, 380, "ControlsPanel1")
...
checkbox.SetValue(True)
'checkbox.LoadSkin("Skin") 'crash?
window.AddChild(checkbox)

Global mcl:ifsoGUI_MCListBox = ifsoGUI_MCListBox.Create(5, 5, 360, 320, "MCListBox")
...
Global buttonG:ifsoGUI_Button = ifsoGUI_Button.Create(500, 10, 80, 25, "gButton", "XX")
		...
		ElseIf e.gadget = mcl And (e.id = ifsoGUI_EVENT_RESIZE Or e.id = ifsoGUI_EVENT_CLICK Or e.id = ifsoGUI_EVENT_CHANGE Or e.id = ifsoGUI_EVENT_CELL_CHANGE)
			Select e.id
				Case ifsoGUI_EVENT_RESIZE
					AddEvent("NAME: MCListBox: Resize Column " + e.data, e.id) 'crash?
